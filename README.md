...
The engine also accepts backend aliases `NEW_ORDER` for create commands and
`CANCEL_ORDER` for cancel commands. Commands without `commandType` are treated as `CREATE`.
